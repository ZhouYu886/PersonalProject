...
- (void)viewDidLoad {
    ...
    UIButton *backB = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, 10, 10)];

      [backB addTarget:self action:@selector(backVC) forControlEvents:UIControlEventTouchUpInside];

     // backB.tag = type;

      [backB setBackgroundImage:[UIImage imageNamed:@"ic_back"] forState:UIControlStateNormal];
...

{
        ...
        
    {
        ...
        //在这里可设置背景色
        _navBackView.backgroundColor = RGB(32, 38, 52);
