...
//        _makeTbv.backgroundColor = TNColor.main_bg_color;
        _makeTbv.backgroundColor = RGB(16, 21, 28);
        //隐藏垂直滚动条
...
//    [self getBackView:self.navigationController.navigationBar];
    ...
    self.view.backgroundColor = RGB(16, 21, 28);
    pageIndex = 2;
    ...
    self.title = @"行情数据";
       self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"<首页" style:0 target:self action:@selector(hui1)];
    self.navigationController.navigationBar.barTintColor = RGB(23, 26, 36);
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    headerView.backgroundColor = RGB(16, 21, 28);
